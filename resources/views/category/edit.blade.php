    ...
    <main id="main" class="main">
        ...
        <center>
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Modifier une categories</h5>
                        @if (session('status'))
                    ...
                    @endif
                        ...
                        <form class="row g-3" method="POST" action="{{ url('category/' . $category->id) }}">
                            @csrf
                            {{ method_field('PATCH') }}

                            <div class="col-12">
                                <input type="text" class="form-control" value="{{ $category->Tilte }}"
                                    placeholder="Titre" name="Tilte">
                            </div>
                            <div class="col-12">
                                <input type="text" class="form-control" value="{{ $category->Type }}"
                                    placeholder="Type" name="Type">
                            </div>
                            <div class="col-12">

                                <input type="Number" class="form-control" value="{{ $category->Dimensions }}"
                                    placeholder="Dimensions" name="Dimensions">
                            </div>
                            <div class="col-12">
                                <input type="Number" class="form-control" value="{{ $category->Material }}"
                                    placeholder="Matiere" name="Material">
                            </div>
