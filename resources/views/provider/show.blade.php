        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Afficher les informations sur le fournisseur</h5>
                            <a href=" {{ url('provider') }} ">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            <th scope="col">Prenom du fournisseur</th>
                                            <td>{{ $provider->FirstName }}</td>
                                        </tr>

                                        <tr>
                                            <th scope="col">BP du fournisseur</th>
                                            <td>{{ $provider->BP }}</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th scope="col">Numero du fournisseur</th>
                                            <td>{{ $provider->Phone }}</td>
                                        </tr>
                                        <tr>
                                            <th scope="col">Le pays du fournisseur</th>
                                            <td>{{ $provider->County }}</td>
                                        </tr>
                                        <tr>
                                            <th scope="col">La ville du fournisseur</th>
                                            <td>{{ $provider->Tows }}</td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <form method="POST" action="{{ url('/provider/delete/' . $provider->id) }} ">
                                                {{ method_field('DELETE') }}
                                                @csrf
