...
<center>
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Ajouter un fournisseurs</h5>

                        <!-- Vertical Form -->
                        <form class="row g-3" method="POST" action="{{ url('provider') }}">
                            @csrf
                            ...
                            <div class="col-12">
                                ...
                                <input type="Number" class="form-control" placeholder="BP" name="BP" required>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <input type="Number" class="form-control" placeholder="+237" name="Phone"
                                    required>
                            </div>
                            <div class="col-12">
                                <input type="text" class="form-control" placeholder="Pays" name="County"
                                    required>
                            </div>
                            <div class="col-12">
                                <input type="text" class="form-control" placeholder="Ville" name="Tows"
                                    required>
                            </div>
