                ...
                <div class="card">
                    ...
                    @endif
                        ...
                        @foreach ($provider as $provider)
                            <form class="row g-3" method="POST" action="{{ url('provider/' . $provider->id) }}">
                                {{ method_field('PATCH') }}
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" value="{{ $provider->FirstName }}"
                                        placeholder="Prenom" name="FirstName">
                                </div>
                                <div class="col-12">

                                    <input type="Number" class="form-control" value="{{ $provider->BP }}"
                                        placeholder="BP" name="BP">
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <input type="Number" class="form-control" value="{{ $provider->Phone }}"
                                        placeholder="Phone" name="Phone">
                                </div>
                                <div class="col-12">
                                    <input type="text" class="form-control" value="{{ $provider->County }}"
                                        placeholder="Pays" name="County">
                                </div>
                                <div class="col-12">
                                    <input type="text" class="form-control" value="{{ $provider->Tows }}"
                                        placeholder="Ville" name="Tows">
                                </div>
