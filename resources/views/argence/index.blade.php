                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Lire les informations les agences</h5>
                            <div>
                            ...
                            @if (Auth::user()->hasPermission('argence-create'))
                                <a href=" {{ url('argence/create') }} ">
                                ...
                                <tbody>
                                    @foreach ($argence as $argence)
                                        <tr>
                                            <td>{{ $argence->id }}</td>
                                            <td>{{ $argence->Name }}</td>
                                            <td>{{ $argence->Places }}</td>

                                            <td>

                                                <form method="POST"
                                                    action="{{ url('/argence/delete/' . $argence->id) }} ">
                                                    {{ method_field('DELETE') }}
                                                    @csrf

                                                    <a href="{{ url('argence/' . $argence->id) }} ">
                                                        <button type="button" class="btn btn-success">
                                                            <i class="bi bi-eye"></i>
                                                        </button>
                                                    </a>
                                                    @if (Auth::user()->hasPermission('argence-update'))
                                                        <a
                                                            href="  {{ url('argence/' . $argence->id . '/edit') }}
                                                    ">
                                                    ...
                                                    @endif
                                                    @if (Auth::user()->hasPermission('argence-delete'))
