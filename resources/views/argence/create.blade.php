...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            @if (Auth::user()->hasPermission('magasinier-read'))
                <li class="nav-item">
                    <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse"
                        href="#">
                        <i class="bi bi-bar-chart"></i><span>Magasinier</span><i
                            class="bi bi-chevron-down ms-auto"></i>
                    </a>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Vertical Form -->
                        <form class="row g-3" method="POST" action="{{ url('argence') }}">
                            @csrf
                            ...
                            <div class="col-12">
                                <select name="Name" id="" class="form-select" required>
                                    ...
                                    <option value="Fodem">Fodem</option>
                            ...
                            <div class="col-12">
                                <select name="Places" id="" class="form-select" required>
                                    <option value="">selectionner le lieux de agence</option>
