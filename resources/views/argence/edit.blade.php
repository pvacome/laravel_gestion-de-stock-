            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="POST" action="{{ url('argence/' . $argence->id) }}">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="col-12">
                                <input type="text" class="form-control" value="{{ $argence->Name }}"
                                    placeholder="Nom" name="Name">
                            </div>
                            <div class="col-12">
                                <input type="text" class="form-control" value="{{ $argence->Places }}"
                                    placeholder="Lieux" name="Places">
                            </div>
