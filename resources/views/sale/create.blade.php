            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Vertical Form -->
                        <form class="row g-3" method="POST" action="{{ url('sale') }}">
                            @csrf

                            <div class="col-12">


                                <input type="text" class="form-control" placeholder="Titre" name="Tilte"
                                    required>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" placeholder="Statut" name="Status"
                                    required>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="Number" class="form-control" placeholder="Marque" name="Mark"
                                    required>
                            </div>
                            {{-- en select --}}
                            {{-- <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="Number" class="form-control" placeholder="Taille" name="Size"
                                    required>
                            </div>
