                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Lire les informations sur la vente</h5>
                                    ...
                                    @foreach ($sale as $sale)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="POST"
                                                    action="{{ url('/sale/delete/' . $sale->id) }} ">
                                                    {{ method_field('DELETE') }}
                                                    @csrf
                                                    ...
                                                    {{-- {{dd(Auth::user())}} --}}
                                                    @if (Auth::user()->hasPermission('sale-update'))
                                                    ...
                                                    @endif
                                                    @if (Auth::user()->hasPermission('sale-delete'))
