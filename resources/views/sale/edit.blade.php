                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <form class="row g-3" method="POST" action="{{ url('sale/' . $sale->id) }}">
                                @csrf
                                {{ method_field('PATCH') }}

                                <div class="col-12">
                                    <input type="text" class="form-control" value="{{ $sale->Tilte }}"
                                        placeholder="Titre" name="Tilte">
                                </div>
                                <div class="col-12">
                                    <input type="text" class="form-control" value="{{ $sale->Type }}"
                                        placeholder="Type" name="Type">
                                </div>
                                <div class="col-12">

                                    <input type="text" class="form-control" value="{{ $sale->Status }}"
                                        placeholder="Statut" name="Status">
                                </div>
                                <div class="col-12">
                                    <input type="text" class="form-control" value="{{ $sale->Description }}"
                                        placeholder="Description" name="Description">
                                </div>
                                <div class="col-12">
                                    <input type="Number" class="form-control" value="{{ $sale->Mark }}"
                                        placeholder="Marque" name="Mark">
                                </div>

                                <div class="col-12">
                                    <input type="Number" class="form-control" value="{{ $sale->Size }}"
                                        placeholder="Taille" name="Size">
                                </div>
