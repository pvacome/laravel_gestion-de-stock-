            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Vertical Form -->
                        <form class="row g-3" method="POST" action="{{ url('imprimer')}}">
                            @csrf
                            ...
                            <div class="col-12">
                                <select class="form-select" name="product">
                                    ...
                                    @foreach ($product as $product)
                                        ...
                                        <option value=" {{ $product->id }}" name="product">{{' Designation : '.  $product->Name .' Prix : '. ($product->UnitPrice)}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12">
                            ...
                            {{-- <div class="col-12">
                                <input type="number" class="form-control" placeholder="PrixUnitaire" name="UnitPrice"
                                 id="UnitPrice" onchange="prix_Total()"   required>
                            </div> --}}
                             <script>
                                function prix_Total(){
                            ...
                            <div class="col-12">
                                ...
                                <input type="hidden" value="{{$id}}" name="bill_id">
