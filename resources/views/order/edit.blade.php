    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Modifier une commande</h5>
                        @if (session('status'))
                    ...
                    @endif
                        ...
                        <form class="row g-3" method="POST" action="{{ url('order/' . $order->id) }}">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="col-12">
                                <select name="product">
                            ...
                            <div class="col-12">
                                <input type="Number" class="form-control" value="{{ $order->Quantity }}"
                                    placeholder="quantite" name="Quantity">
                            </div>
                            <div class="col-12">
                                <input type="Number" class="form-control" value="{{ $order->UnitPrice }}"
                                    placeholder="PrixUnitaire" name="UnitPrice">
                            </div>
                            <div class="col-12">

                                <input type="Number" class="form-control" value="{{ $order->TotalPrice }}"
