...
<head>
    ...
    <link rel="stylesheet" href=" {{ (' bootstrap-5.0.2-dist - Copie/css/bootstrap.css')}}">
...
<body>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Lire la liste des utilisateurs</h5>
                            @if (Auth::user()->hasPermission('user-create'))
                                {{-- <a href=" {{ url('user/create') }} "> --}}
                                    <button type="submit" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#hello">
                                        Ajouter
                                     </button>

                                {{-- ajout du formulaire --}}

                                <div class="modal" tabindex="-1" id="hello">
    ...
    <script src=" {{(' bootstrap-5.0.2-dist - Copie/js/bootstrap.min.js')}}"></script>
