    ...
    <main id="main" class="main">
        ...
        <center>
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Modifier un inventaire</h5>


                        <form class="row g-3" method="POST" action="{{ url('inventory/' . $inventory->id) }}">
                            @csrf
                            {{ method_field('PATCH') }}

                            <div class="col-12">
                                <input type="text" class="form-control" value="{{ $inventory->Designation }}"
                                    placeholder="Designation" name="Designation">
                            </div>
                            <div class="col-12">
                                <input type="date" class="form-control" value="{{ $inventory->ExpirationDate }}"
                                    placeholder="DateDePeremption" name="ExpirationDate">
                            </div>


                            <div class="col-12">

                                <input type="Number" class="form-control" value="{{ $inventory->QuantityInStock }}"
                                    placeholder="QteEnStock" name="QuantityInStock">
                            </div>


                            <div class="col-12">
                                <input type="Number" class="form-control" value="{{ $inventory->StockAvailable }}"
                                    placeholder="StockDisponible" name="StockAvailable">
                            </div>
                            <div class="col-12">
                                <input type="Number" class="form-control" value="{{ $inventory->UnitPrice }}"
                                    placeholder="PrixUnitaire" name="UnitPrice">
                            </div>
                            <div class="col-12">
                                <input type="Number" class="form-control"
                                    value="{{ $inventory->ActualStockValue }}" placeholder="StockReel"
                                    name="ActualStockValue">
                            </div>
                            <div class="col-12">
                                <input type="Number" class="form-control" value="{{ $inventory->DeviationValue }}"
                                    placeholder="ValeurEcart" name="DeviationValue">
                            </div>
                            <div class="col-12">
                                <input type="text" class="form-control" value="{{ $inventory->Observation }}"
                                    placeholder="Observation" name="Observation">
                            </div>
                            <div class="col-12">
                                <select name="product">
                                    <option selected="selected">selectionner le produit</option>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary">Emvoyer</button>
