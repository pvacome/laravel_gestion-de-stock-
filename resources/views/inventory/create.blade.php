            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Vertical Form -->
                        <form class="row g-3" method="POST" action="{{ url('inventory') }}">
                            @csrf
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <input type="date" class="form-control" placeholder="DateDePeremption"
                            ...
                            <script>
                                function automatisation() {
                                    ...
                                    let r = document.getElementById('QuantityInStock').value;
                                    let o = document.getElementById('StockAvailable').value;
                                    let s = document.getElementById('UnitPrice').value;
                            ...
                            <div class="col-12">
                                ...
                                <input type="Number" class="form-control" placeholder="QteEnStock"
                                    name="QuantityInStock" id="QuantityInStock" onchange="automatisation()" required>
                            </div>
                            <div class="col-12">
                                <input type="Number" class="form-control" placeholder="StockDisponible"
                                    name="StockAvailable" id="StockAvailable" onchange="automatisation()" required>
                            </div>
                            <div class="col-12">
                                <input type="Number" class="form-control" placeholder="PrixUnitaire"
                                    name="UnitPrice" id="UnitPrice" onchange="automatisation()" required>
                            </div>
                            <div class="col-12">
                                <input type="Number" class="form-control" placeholder="StockReel"
                                    name="ActualStockValue" id="ActualStockValue" onchange="automatisation()"
                                    required>
                            </div>
                            <div class="col-12">
                                <input type="Number" class="form-control" placeholder="ValeurEcart"
                                    name="DeviationValue" required>
                            </div>
                            <div class="col-12">
