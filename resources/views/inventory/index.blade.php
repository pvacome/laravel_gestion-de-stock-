                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Lire les inventaires</h5>
                            <div>
                            ...
                            @if (Auth::user()->hasPermission('inventories-create'))
                                ...
                                <tbody>
                                    @foreach ($inventory as $inventory)
                                        <tr>
                                            ...
                                            <td>{{ $inventory->ActualStockValue }}</td>
                                            <td>{{ $inventory->DeviationValue }}</td>
                                            <td>{{ $inventory->Observation }}</td>
                                            <td>

                                                <form method="POST"
                                                action="{{ url('/inventory/delete/' . $inventory->id) }} ">
                                                {{ method_field('DELETE') }}
                                                @csrf
                                                ...
                                                @if (Auth::user()->hasPermission('inventories-update'))
                                                    <a
                                                        href="  {{ url('inventory/' . $inventory->id . '/edit') }}
                                                ">
                                                ...
                                                @if (Auth::User()->hasPermission('inventories-delete'))
