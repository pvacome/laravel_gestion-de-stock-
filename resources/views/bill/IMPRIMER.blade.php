                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    @foreach ($imprimer as $imprimer)
                                        <tr>
                                            <td>{{ $imprimer->id }}</td>
                                             <td>{{ $imprimer->produit->name}}</td>
                                            {{-- {{ dd($imprimer->produit)}} --}}

                                            <td>{{ $imprimer->Quantity }}</td>
                                            <td>{{ $imprimer->UnitPrice }}</td>
                                            <td>{{ $imprimer->TotalPrice }}</td>
                                            <td>

                                            <form method="POST"
                                                    action="{{ url('/imprimer/delete/' . $imprimer->id) }} ">
                                                    {{ method_field('DELETE') }}
                                                    @csrf


                                                    @if (Auth::user()->haspermission('bill-show'))
                                                    ...
                                                    @endif
                                                    @if (Auth::user()->haspermission('bill-update'))
                                                        <a
                                                            href="  {{ url('bill/' . $bill->id . '/edit') }}
                                                    ">
