                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        @if (session('status'))
                            ...
                            <div class="alert alert-danger alert-dismissible fade show" style="width: 25cm;"
                                role="alert">
                                {{ session('status') }}
                    ...
                    <form class="row g-3" method="POST" action="{{ url('bill/' . $bill->id) }}">
                        @csrf
                        {{ method_field('PATCH') }}
                        ...
                        <br>
                        <div class="col-12">
                            <input type="Number" class="form-control" value="{{ $bill->Number }}"
                                placeholder="numero" name="Number">
                        </div>
                        <div class="col-12">
                            <input type="date" class="form-control" value="{{ $bill->date }}"
