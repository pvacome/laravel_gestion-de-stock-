                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if (Auth::user()->haspermission('bill-create'))
                                <a href=" {{ url('bill/create') }} ">
                                    ...
                                    @foreach ($bills as $bill)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="POST"
                                                    action="{{ url('/bill/delete/' . $bill->id) }} ">
                                                    {{ method_field('DELETE') }}
                                                    @csrf
                                                    ...
                                                    @if (Auth::user()->haspermission('bill-delete'))
