        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                @endif
                    ...
                    @endif
                    @if (Auth::user()->hasPermission('argenceread'))
                        <li>
                            <a href=" {{ url('argence') }} ">
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                       ...
                       <center> <h5 class="card-title">Ajouter un produits</h5></center>

                        <!-- Vertical Form -->
                        <form class="row g-3" method="POST" action="{{ url('product') }}">
                            @csrf
                            <div class="col-20">
                                <select class="form-select" name="argence" required>
                                    <option selected="selected">selectionner l'argence</option>
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control" placeholder="Libelle" name="Labels"
                                    required>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <input type="Number" class="form-control" placeholder="Qte"
                                    name="Quantity" id="Quantity" onchange="prix_total()" required>
                            </div>
                            <div class="col-12">
                                <input type="Number" class="form-control" placeholder="Numero" name="Number"
                                    required>
                            </div>
                           <script>
                            function prix_total(){
                            ...
                            <div class="col-12">
                                <input type="Number" class="form-control" placeholder="PrixTotal" name="TotalPrice"
                                  id="TotalPrice"  required>
                            </div>
                            <div class="col-12">
                                <input type="Date" class="form-control" placeholder="DateExpiration"
                                    name="ExpirationDate" required>
                                    <span>Date d'inspiration</span>
                            </div>
                            <div class="col-12">
                                <input type="Date" class="form-control" placeholder="DateMiseAjout"
                                    name="DateOfManufacture" required>
                                    <span>Date mise a jour</span>
                            </div>
