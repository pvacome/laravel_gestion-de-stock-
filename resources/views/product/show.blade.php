        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Information sur les produits</h5>
                            <a href=" {{ url('product') }} ">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            <th scope="col">Designation du produit</th>
                                            <td>{{ $product->Designation }}</td>
                                        </tr>
                                        <tr>
                                            <th scope="col">Quantite du produit</th>
                                        ...
                                        <tr>
                                            <th scope="col">Prix Unitaire du produit</th>
                                        ...
                                        <tr>
                                            <th scope="col">Date Inspiration du produit</th>
