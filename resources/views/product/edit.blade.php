        ...
        <div class="pagetitle">
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <center>
                       <center> <h5 class="card-title">Modifier un produit</h5></center>
                   ...
                   @endif
                            ...
                            <form class="row g-3" method="POST" action="{{ url('product/' . $product->id) }}">

                                {{ method_field('PATCH') }}
                                @csrf
                                <div class="col-12">
                                    <select class="form-select" name="provider">
                                        <option selected="selected">selectionner le fournisseur</option>
                                ...
                                <div class="col-12">
                                    <select class="form-select" name="category">
                                        <option selected="selected">selectionner la categorie</option>
                                        @foreach ($category as $category)
                                            <option value=" {{ $category->id }}"> {{ $category->Tilte}} </option>
                                        @endforeach
                                    </select>
                                </div> <br>
                                <div class="col-12">
                                    <select class="form-select" name="argence">
                                        <option selected="selected">selectionner l'agence</option>
                                        @foreach ($argence as $argence)
                                            <option value=" {{ $argence->id }}"> {{ $argence->Name}} </option>
                                        @endforeach
                                    </select>
                                </div> <br>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" value="{{ $product->Labels }}"
                                        placeholder="Libelle" name="Labels">
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" value="{{ $product->Designation }}"
                                        placeholder="Designation" name="Designation">
                                </div>
                                <div class="col-12">
                                    <input type="Number" class="form-control" value="{{ $product->Quantity }}"
                                        placeholder="Qte" name="Quantity">
                                </div>
                                <div class="col-12">
                                    <input type="Number" class="form-control" value="{{ $product->Number }}"
                                        placeholder="Quantite" name="Number">
                                </div>
                                <div class="col-12">
                                    <input type="Number" class="form-control" value="{{ $product->UnitPrice }}"
                                        placeholder="PU" name="UnitPrice">
                                </div>
                                <div class="col-12">
                                    <input type="Number" class="form-control" value="{{ $product->TotalPrice }}"
                                        placeholder="PrixTotal" name="TotalPrice">

                                </div>
                                <div class="col-12">
                                    <input type="date" class="form-control"
                                        value="{{ $product->ExpirationDate }}" placeholder="DateExpiration"
                                        name="ExpirationDate">
                                        <span>Date d'inspiration</span>
                                </div>
                                <div class="col-12">
                                    <input type="date" class="form-control"
                                        value="{{ $product->DateOfManufacture }}" placeholder="DateMiseAjout"
                                        name="DateOfManufacture">
                                        <span>Date de mise a jour</span>
                                    </div>
